            ...
            <Navbar bg="dark" variant="dark">
                ...
                >
                    ...
                    <NavDropdown title="Projects" id="navbarScrollingDropdown">
                        <NavDropdown.Item href="/projects">Display</NavDropdown.Item>
                        <NavDropdown.Item href="/createProject">Create</NavDropdown.Item>
                        <NavDropdown.Divider />
                        <NavDropdown.Item href="#action5">Something else here</NavDropdown.Item>
                    </NavDropdown>
                    <NavDropdown title="Tasks" id="navbarScrollingDropdown">
                        <NavDropdown.Item href="/tasks">Display</NavDropdown.Item>
                        <NavDropdown.Item href="/createTask">Create</NavDropdown.Item>
                        <NavDropdown.Divider />
                        <NavDropdown.Item href="#action5">Something else here</NavDropdown.Item>
                    </NavDropdown>
                </Nav>
